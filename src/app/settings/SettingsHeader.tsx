...
export default function SettingsHeader({ userProfile }: { userProfile: UserProfile }) {
    ...
    <nav className="w-full bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-800 px-6 py-4 flex justify-between items-center shadow-sm sticky top-0 z-50 transition-colors">
      <div className="flex items-center gap-6">
        ...
        <div className="hidden sm:flex items-center gap-4 border-l border-gray-200 dark:border-slate-700 pl-6">
          ...
          <Link href="/analytics" className="text-sm font-semibold text-gray-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
            Analytics
          </Link>
          <Link href="/settings" className="text-sm font-bold text-blue-600 dark:text-blue-400 transition-colors">
            Settings
          </Link>
        </div>
      </div>
